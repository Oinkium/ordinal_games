...
We fix some ordinal $\alpha$ throughout.  
...
\begin{definition}
  ...
  \begin{description}
    ...
    \item[Limit condition] If $\mu<\alpha$ is a limit ordinal and $s$ is a sequence of length $\mu$ such that every proper prefix $t\pprefix s$ is in $P_A$, then $s$ is in $P_A$.  
  \end{description}
\end{definition}
