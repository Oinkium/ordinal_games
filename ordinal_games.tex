...
\begin{proof}[Proof of Proposition \ref{CnUniversalProperty}]
  ...
  We claim that $\comp{\grel{\cn_A}}{\grel{\sigma^{\cn}}}=\grel{\sigma}$.  If $(s,t)\in\comp{\grel{\cn_A}}{\grel{\sigma^{\cn}}}$ then there exists $u\in P_{A^{\cn}}$ such that $(s,u)\in\grel{\sigma^{\cn}}$ and $(u,t)\in\grel{\cn_A}$.  That means that $(s,u\vert_{M_A})$ in $\grel\sigma$ and $u\vert_{M_A}=t$.  Therefore, $(s,t)\in\grel\sigma$.  So $\comp{\grel{\cn_A}}{\grel{\sigma^{\cn}}}\subset\grel\sigma$.  
\end{proof}
