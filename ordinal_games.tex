...
This can be shown in an easy way.  Roughly speaking, we write out the sequence $s$, and then insert immediately after each $B$-move the moves from $t$ that occur at that point in the sequence.  This works for arbitrary sequences
