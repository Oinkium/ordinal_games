...
\begin{remark}[Notes on the definition]
  ...
  Given the game $A$, we define $L_A$ to be the set of all plays $s\in P_A$ such that $s_n=O$ for all odd $n$ and $s_n=P$ for all even $n$ - in other words, the set of plays in $P_A$ that start with an $O$-move.
\end{remark}
