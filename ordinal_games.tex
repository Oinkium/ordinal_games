...
\begin{corollary}
  Let $\alpha$ be an ordinal of the form $\omega^beta$.  Let $A,B,C$ be acn $\alpha$-games, let $\sigma$ be a strategy for $A\implies B$ and let $\tau$ be a strategy for $B\implies C$.  Set
  \[
    \comp\tau\sigma = \{\s\vert_{A,C}\suchthat\s\in\sigma\|\tau\}
    \]
  ...
  \begin{proof}
    ...
    We now need to show that the two strategy conditions are satisfied.  
  \end{proof}
\end{corollary}
