...
\begin{proof}[Proof of Proposition \ref{CnUniversalProperty}]
  ...
  In other words, the relational presentation $\grel{\cn_A}$ is the graph of an injective function $f\colon P_A\to P_{A^{\cn}}$, so it is a split epimorphism in $\Rel$.  It follows that there is
\end{proof}
